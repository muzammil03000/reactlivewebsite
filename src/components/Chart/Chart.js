...
class Chart extends Component {
    ...
    render() {
        const white = "rgba(46, 204, 113,0.9)";
        return (
            <>
                <Container className="border-bottom" style={{marginTop:'50rem'}}>
                    <Row>
                        <Col lg={6} md={12} sm={12} style={{width:'200%', height:'330px'}}>
                            <ResponsiveContainer>
                                <BarChart width={100} height={300} data={this.state.data}>
                                    <XAxis dataKey="Technology"/>
                                    <Tooltip/>
                                    <Bar dataKey="Projects" fill={white} >
                                    </Bar>
                                </BarChart>
                            </ResponsiveContainer>
                        </Col>
